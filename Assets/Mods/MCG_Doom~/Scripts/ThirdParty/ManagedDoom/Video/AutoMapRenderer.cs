...
namespace ManagedDoom.Video
{
    public sealed class AutoMapRenderer
    {
        ...
        public void Render(Player player)
        {
            ...
            renderViewX = MCG_Doom.Compatibility.ManagedDoomNet472Compat.Round(zoom * ppu * actualViewX) / (zoom * ppu);
            renderViewY = MCG_Doom.Compatibility.ManagedDoomNet472Compat.Round(zoom * ppu * actualViewY) / (zoom * ppu);
            ...
            for (var i = 0; i < am.Marks.Count; i++)
            {
                ...
                screen.DrawPatch(
                    markNumbers[i],
                    (int)MCG_Doom.Compatibility.ManagedDoomNet472Compat.Round(pos.X),
                    (int)MCG_Doom.Compatibility.ManagedDoomNet472Compat.Round(pos.Y),
                    scale);
            }
