            ...
            public void Process(float[] inputBlock, float[] outputBlock)
            {
                ...
                while (blockIndex < outputBlock.Length)
                {
                    ...
                    for (var t = 0; t < rem; t++)
                    {
                        ...
                        if (MCG_Doom.Compatibility.ManagedDoomNet472Compat.Abs(output) < 1.0E-6F)
                        {
                            output = 0F;
                        }

                        filterStore = (output * damp2) + (filterStore * damp1);
                        if (MCG_Doom.Compatibility.ManagedDoomNet472Compat.Abs(filterStore) < 1.0E-6F)
                        {
                            filterStore = 0F;
                        }
            ...
            public void Process(float[] block)
            {
                ...
                while (blockIndex < block.Length)
                {
                    ...
                    for (var t = 0; t < rem; t++)
                    {
                        ...
                        if (MCG_Doom.Compatibility.ManagedDoomNet472Compat.Abs(bufout) < 1.0E-6F)
                        {
                            bufout = 0F;
                        }
