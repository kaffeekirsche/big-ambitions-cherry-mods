...
[*][b]Ride requests arrive over time.[/b] The accept/decline dialog only opens once you have
...
expires quietly.
[*][b]A passenger is waiting at the door.[/b] Drive into the marked circle to pick them up, then
to the destination circle to drop them off.
[*][b]Map filter.[/b] A "QuickRid" entry under the Jobs category on the city map shows your
current pickup or destination. Toggle it like any other filter.
[*][b]Fare by distance[/b], with a rush hour surcharge (07:00–09:00 and 16:00–19:00) and a night
surcharge (22:00–05:00).
[*][b]Star rating per ride[/b] from your time window and the damage you took on the way. Your
running average feeds back into the fares you are offered.
[*][b]Tips[/b] on rides rated four stars or better, as a share of the fare.
[*][b]Session summary[/b] when you go offline: rides, fares, tips and your average rating.
...
[list]
[*][b]Match game difficulty[/b] (default) – follows the difficulty of your save.
[*][b]Easy[/b] – higher fares, generous time windows, more tips.
...
[i]Logo, banner and map icon were created with AI image tools and reworked by hand. All code and gameplay were built and tested by hand.[/i]
...
[*][b]Fahrtanfragen kommen mit der Zeit.[/b] Der Annehmen/Ablehnen-Dialog öffnet erst, wenn du
...
lautlos.
[*][b]Der Fahrgast wartet an der Tür.[/b] Fahre in den markierten Kreis zum Einsteigen, danach in
den Kreis am Ziel zum Absetzen.
[*][b]Kartenfilter.[/b] Ein Eintrag "QuickRid" in der Kategorie Jobs auf der Stadtkarte zeigt den
aktuellen Abhol- oder Zielpunkt. Er lässt sich wie jeder andere Filter an- und abschalten.
[*][b]Fahrpreis nach Entfernung[/b], mit Aufschlag in der Hauptverkehrszeit (07:00–09:00 und
16:00–19:00) und nachts (22:00–05:00).
[*][b]Sterne je Fahrt[/b] aus dem Zeitfenster und dem Schaden, den du unterwegs einfährst. Dein
laufender Schnitt wirkt auf die Preise, die dir angeboten werden.
[*][b]Trinkgeld[/b] ab vier Sternen, als Anteil des Fahrpreises.
[*][b]Sitzungsübersicht[/b] beim Offline-Gehen: Fahrten, Einnahmen, Trinkgeld und der
...
[list]
[*][b]Wie Spiel[/b] (Standard) – folgt der Schwierigkeit deines Spielstands.
[*][b]Leicht[/b] – höhere Fahrpreise, großzügige Zeitfenster, mehr Trinkgeld.
